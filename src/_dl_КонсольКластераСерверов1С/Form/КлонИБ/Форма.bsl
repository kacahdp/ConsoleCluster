...
Функция ПолучитьДанныеПоУмолчанию()
	...
	Если ТаблицаИменIpИИмен.Количество() = 6 Тогда
		...
		СтруктураVM4.Вставить("node_name", 		ТаблицаИменIpИИмен[3].name+"."+СтруктураПоУмолчанию.Домен);
		...
		СтруктураVM5.Вставить("node_name", 		ТаблицаИменIpИИмен[4].name+"."+СтруктураПоУмолчанию.Домен);
...
Функция РеквизитыИменИБВКластере(ИБ)
	...
	Если ВыборкаСУБД.Следующий() Тогда	
		ПараметрыДанных.ИмяВСУБД = Выборка1с.ИмяВСУБД;	
	КонецЕсли;
