		...
		Для каждого ГруппировкаЭлементов Из МассивГруппировокЭлементов Цикл			
			...
			Для каждого Стр Из СоответствиеИменЭлементов Цикл 
				...
				Для каждого ЭлементСтруктуры Из СтруктураРеквизитов Цикл
					ЗаписатьРеквизитыВРС(ЭлементСтруктуры.Значение, ЗначенияПоУмолчанию, ЭлементСтруктуры.Ключ, Стр.Значение);
				КонецЦикла;   
				
				ЗаполнитьДанныеНоды(РеквизитыДиска, Стр.Значение, ЗначенияПоУмолчанию);
			КонецЦикла;	
		КонецЦикла;
	КонецЕсли;	
...
&НаСервере
Процедура ЗаполнитьДанныеНоды(ТЗРеквизиты, ИмяНоды, ЗначенияПоУмолчанию)
...
&НаСервере
Процедура ЗаписатьРеквизитыВРС(ТЗРеквизиты, ЗначенияПоУмолчанию, ГруппировкаРеквизитов = "", ИмяНоды = "")
...
Процедура ДеревоРеквизитовПриАктивизацииСтроки(Элемент)
	...
	ОписаниеРеквизита 						= ТекущиеДанные.Описание;
	Элементы.ОписаниеРеквизита.Подсказка 	= ТекущиеДанные.Описание; 
