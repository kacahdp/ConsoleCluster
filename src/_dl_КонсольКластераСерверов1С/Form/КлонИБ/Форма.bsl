...
Процедура ЗаполнитьПараметры()
	...
	ТЗРеквизиты = ПолучитьРеквизитыИзМакета("РеквизитыДиска");
	...
	Если ТекущееШаблонРазвертки = "ВсеНаОдном" Тогда
		...
		ЗаписатьРеквизитыВРСиДерево(ДеревоСерверов, ТЗРеквизиты);	
	...
	ИначеЕсли ТекущееШаблонРазвертки = "Кластер" Тогда		
		...
		Для каждого ГруппировкаЭлементов Из МассивГруппировокЭлементов Цикл
			...
			Для каждого ИмяЭлемента Из МассивИменЭлементов Цикл
				...
				ЗаписатьРеквизитыВРСиДерево(ТЗРеквизиты, СтрокаДереваГруппировка);
			КонецЦикла;	
		КонецЦикла;
	КонецЕсли;	
...
&НаСервере
Процедура ЗаписатьРеквизитыВРСиДерево(ТЗРеквизиты, Дерево)
	...
	Для каждого СтрокаТЗ Из ТЗРеквизиты Цикл
		...
		Запись.Значение					= СтрокаТЗ.ЗначениеПоУмолчанию;
