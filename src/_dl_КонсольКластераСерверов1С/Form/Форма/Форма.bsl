...
Процедура Обновить(Команда) 
	...
	ЗаполнитьДеревоКонсоли(); 
	СвернутьРазвернутьДерево(Дерево.ПолучитьЭлементы(), "Дерево", Истина);
...
Процедура Clone(Команда)
	...
	ОткрытьФорму("Обработка._dl_КонсольКластераСерверов1С.Форма.КлонИБ",,ЭтаФорма,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);	
...
Процедура CloneИБ(Команда)
	...
	ОткрытьФорму("Обработка._dl_КонсольКластераСерверов1С.Форма.КлонИБ", ПараметрыФормы, ЭтаФорма,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);	
